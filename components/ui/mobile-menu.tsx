      ...
      <div ref={mobileNav}>
        ...
        >
          <ul className="px-5 py-2">
            <li>
              <Link href="https://app.qualifire.xyz/" className="flex font-medium w-full text-gray-600 hover:text-gray-900 py-2 justify-center" onClick={() => setMobileNavOpen(false)}>Sign in</Link>
            </li>
            <li>
